...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    let applicationId:UInt = 33948
    let appServiceKey = "CT-FrCm9COVksaS"
    let authorizationSecret = "TTj6E4uGLLLRWdB"
    let accountKey = "uxNkcwySgcrtJR9szXE6"

    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        
        QBSettings.setApplicationID(applicationId)
        QBSettings.setAuthKey(appServiceKey)
